...
*(Requires: collectd.modules, collectd.python)*

Enables and configures the elasticsearch plugin, providing detailed metrics on an elasticsearch service.
The data collection can be configured using the pillar as below, which illustrates the defaults if none are given.
